...
**
** Created: Fri May 18 08:10:35 2012
...
public:
    ...
    void setupUi(QWidget *Dialog_CGerais)
    {
        ...
        dim_regiao_livre_x->setValue(0.5);
        ...
        dim_regiao_livre_y->setValue(0.5);
        ...
        dim_regiao_livre_z->setValue(0.5);
        ...
        delta_regiao_livre->setValue(0.005);
